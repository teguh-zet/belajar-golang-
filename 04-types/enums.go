...
// <-- Di Run, tidak ada keyword khusus bernama enum
// seperti di bahasa Java atau C. Sebaliknya, Enum di Run dibuat dengan
...
// Di Run, jika sebuah tipe memiliki method bernama String()
